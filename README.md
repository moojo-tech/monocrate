...
> **⚠️ ESM only** — monocrate requires ES modules. It will not work with CommonJS packages (`.cjs` files or `.js` without `"type": "module"`). If your monorepo uses CommonJS, consider [migrating to ESM](https://nodejs.org/api/esm.html).
