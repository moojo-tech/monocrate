...
- **Bundler approach**: Tools like [esbuild](https://esbuild.github.io/) produce a self-contained blob, but types and sourcemaps break, and consumers can't tree-shake.
